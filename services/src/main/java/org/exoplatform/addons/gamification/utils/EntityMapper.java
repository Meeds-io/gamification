...
public class EntityMapper {
  ...
  public static Announcement fromEntity(GamificationActionsHistoryEntity announcementEntity) {
  ...
  public static GamificationActionsHistoryEntity toEntity(Announcement announcement, RuleEntity ruleEntity) {
    if (announcement == null) {
      return null;
    }
  ...
  public static List<Announcement> fromAnnouncementEntities(List<GamificationActionsHistoryEntity> announcementEntities) {
