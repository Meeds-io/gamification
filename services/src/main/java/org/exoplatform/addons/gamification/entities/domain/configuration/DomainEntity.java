...
@NamedQueries({
    ...
    @NamedQuery(name = "GamificationDomain.findEnabledDomainByTitle", query = "SELECT domain FROM GamificationDomain domain where domain.title = :domainTitle AND domain.isEnabled = true"),
