...
@NamedQuery(name = "GamificationActionsHistory.findAllActionsHistory", query = "SELECT"
    + " new org.exoplatform.addons.gamification.service.StandardLeaderboard(g.earnerId, SUM(g.actionScore) as total)"
...
@NamedQuery(name = "GamificationActionsHistory.findActionsHistoryByEarnerIdSortedByDate", query = "SELECT g FROM GamificationActionsHistory g WHERE g.earnerId = :earnerId AND g.status <> :status ORDER BY g.createdDate DESC")
...
@NamedQuery(name = "GamificationActionsHistory.findStatsByUser", query = "SELECT"
    + " new org.exoplatform.addons.gamification.service.PiechartLeaderboard(g.domainEntity.title,SUM(g.actionScore))"
...
@NamedQuery(name = "GamificationActionsHistory.findDomainScoreByUserId", query = "SELECT"
    + " new org.exoplatform.addons.gamification.service.ProfileReputation(g.domain,SUM(g.actionScore))"
...
@NamedQuery(name = "GamificationActionsHistory.findAllLeaderboardBetweenDate", query = "SELECT"
    ...
    + " GROUP BY  g.earnerId" + " ORDER BY total DESC")
...
@NamedQuery(name = "GamificationActionsHistory.getAllPointsByDomain", query = "SELECT g" + " FROM GamificationActionsHistory g"
...
@NamedQuery(name = "GamificationActionsHistory.getDomainList", query = "SELECT g.domain" + " FROM GamificationActionsHistory g"
    + "     GROUP BY  g.domain")
...
@NamedQuery(name = "GamificationActionsHistory.findAllAnnouncementByChallenge", query = "SELECT DISTINCT a FROM GamificationActionsHistory a where a.ruleId = :challengeId order by a.id desc")
@NamedQuery(name = "GamificationActionsHistory.findMostRealizedRuleIds", query = "SELECT a.ruleId FROM GamificationActionsHistory a where a.type= :type AND a.createdDate >= :fromDate AND a.createdDate < :toDate "
    + "group by a.ruleId order by count(*) DESC")
public class GamificationActionsHistoryEntity extends AbstractAuditingEntity implements Serializable {
