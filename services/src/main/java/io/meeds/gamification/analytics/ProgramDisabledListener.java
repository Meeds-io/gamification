...
public class ProgramDisabledListener extends Listener<DomainDTO, String> {

  private IdentityManager identityManager;

  private SpaceService    spaceService;

  public ProgramDisabledListener(IdentityManager identityManager, SpaceService spaceService) {
