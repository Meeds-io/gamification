...
public class ProgramDeletedListener extends Listener<DomainDTO, String> {

  private IdentityManager identityManager;

  private SpaceService    spaceService;

  public ProgramDeletedListener(IdentityManager identityManager, SpaceService spaceService) {
