...
public class ProgramUpdatedListener extends Listener<DomainDTO, String> {

  private IdentityManager identityManager;

  private SpaceService    spaceService;

  public ProgramUpdatedListener(IdentityManager identityManager, SpaceService spaceService) {
