...
public class ActionAnnouncedTemplateBuilder extends AbstractTemplateBuilder {
  ...
  public ActionAnnouncedTemplateBuilder(RuleService ruleService,
  ...
  protected MessageInfo makeMessage(NotificationContext ctx) { // NOSONAR
    ...
    String announcementId = notification.getValueOwnerParameter(ANNOUNCEMENT_ID_NOTIFICATION_PARAM);
