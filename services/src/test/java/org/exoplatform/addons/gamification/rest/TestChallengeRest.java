...
public class TestChallengeRest extends AbstractServiceTest {
    ...
    public void testCreateChallenge() {
        try {
            ...
            String restPath = "/gamification/challenge/api/addChallenge";
            ...
            jsonWriter.object()
                    ...
                    .value(endDate)
                    .key("managers")
                    .value(Collections.singletonList(1l).toString())
                    .key("points")
                    .value("10")
                    .key("program")
    ...
    public void testUpdateChallenge() {
        try {
            ...
            restPath = "/gamification/challenge/api/updateChallenge";
    ...
    public void testGetChallengeById() {
        try {
            ...
            assertNotNull(challengeRestEntity);
            startSessionAs("root2");
            restPath = "/gamification/challenge/api/0";
            ...
            restPath = "/gamification/challenge/api/555";
            httpRequest = new MockHttpServletRequest(restPath, null, 0, "GET", null);
            envctx.put(HttpServletRequest.class, httpRequest);
            ...
            restPath = "/gamification/challenge/api/" + challengeRestEntity.getId();
            httpRequest = new MockHttpServletRequest(restPath, null, 0, "GET", null);
            envctx.put(HttpServletRequest.class, httpRequest);
            response = launcher.service("GET", restPath, "", h, null, envctx);
            assertNotNull(response);
    ...
    public void testDeleteChallenge() {
        try {
            ...
            //challenge id 0
            restPath = "/gamification/challenge/api/delete/0";
            httpRequest = new MockHttpServletRequest(restPath, null, 0, "GET", null);
            envctx.put(HttpServletRequest.class, httpRequest);
            ...
            restPath = "/gamification/challenge/api/delete/1100";
            httpRequest = new MockHttpServletRequest(restPath, null, 0, "GET", null);
            envctx.put(HttpServletRequest.class, httpRequest);
            ...
            //unauthorized user
            restPath = "/gamification/challenge/api/delete/" + challengeRestEntity.getId();
            httpRequest = new MockHttpServletRequest(restPath, null, 0, "GET", null);
            envctx.put(HttpServletRequest.class, httpRequest);
            response = launcher.service("DELETE", restPath, "", h, null, envctx);
            assertNotNull(response);
    ...
    public void testCanAddChallenge() {
        try {
            startSessionAs("root1");
            String restPath = "/gamification/challenge/api/canAddChallenge";
            EnvironmentContext envctx = new EnvironmentContext();
