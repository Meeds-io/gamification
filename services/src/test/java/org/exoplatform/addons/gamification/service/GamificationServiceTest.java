...
public class GamificationServiceTest extends AbstractServiceTest {
  ...
  public void testSaveActionHistory() {
    List<GamificationActionsHistoryEntity> histories = gamificationHistoryDAO.findAll();
    assertEquals(histories.size(), 0);
    RuleDTO newRuleDTO = newRuleDTO();

    GamificationActionsHistoryEntity aHistory = gamificationService.build(newRuleDTO,
                                                                    TEST_USER_SENDER,
                                                                    TEST_USER_RECEIVER,
                                                                    TEST_LINK_ACTIVITY);
    ...
    GamificationActionsHistoryEntity gamificationActionsHistory = histories.get(0);
  ...
  public void testComputeTotalScore() {
    ...
    GamificationActionsHistoryEntity aHistory = gamificationService.build(ruleDTO,
                                                                    TEST_USER_SENDER,
                                                                    TEST_USER_RECEIVER,
                                                                    TEST_LINK_ACTIVITY);
    gamificationService.saveActionHistory(aHistory);
    GamificationActionsHistoryEntity aHistory1 = gamificationService.build(ruleDTO,
                                                                     TEST_USER_SENDER,
                                                                     TEST_USER_RECEIVER,
                                                                     TEST_LINK_ACTIVITY);
  ...
  public void testFindLatestActionHistoryBySocialId() {
    ...
    try {
      ...
      GamificationActionsHistoryEntity aHistory1 = gamificationService.build(ruleDTO,
                                                                       ...
                                                                       TEST_LINK_ACTIVITY);
      gamificationService.saveActionHistory(aHistory1);
      GamificationActionsHistoryEntity aHistory2 = gamificationService.build(ruleDTO,
                                                                       TEST_USER_SENDER,
                                                                       TEST_USER_RECEIVER,
                                                                       TEST_LINK_ACTIVITY);
      gamificationService.saveActionHistory(aHistory2);

      GamificationActionsHistoryEntity history = gamificationService.findLatestActionHistoryByEarnerId(TEST_USER_SENDER);
