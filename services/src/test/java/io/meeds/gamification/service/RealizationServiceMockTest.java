...
public class RealizationServiceMockTest extends AbstractServiceTest {
  ...
  public void testLeaderboardRank() {
    ...
    int rankUser1 = realizationService.getLeaderboardRank(TEST_USER_EARNER, date, null, program.getId());
    int rankUser2 = realizationService.getLeaderboardRank(TEST_USER_RECEIVER, date, null, program.getId());
    assertEquals(1, rankUser1);
    assertEquals(2, rankUser2);

    int rankSpace2 = realizationService.getLeaderboardRank(TEST_SPACE2_ID, date, null, program.getId());
    int rankSpace1 = realizationService.getLeaderboardRank(TEST_SPACE_ID, date, null, program.getId());
