...
import org.exoplatform.addons.gamification.service.ProfileReputation;
import org.exoplatform.addons.gamification.service.StandardLeaderboard;
import org.exoplatform.commons.persistence.impl.GenericDAOJPAImpl;

public class GamificationHistoryDAO extends GenericDAOJPAImpl<GamificationActionsHistoryEntity, Long> {
   ...
   */
  public List<GamificationActionsHistoryEntity> findActionsHistoryByEarnerIdSortedByDate(String earnerId, int limit) {
    TypedQuery<GamificationActionsHistoryEntity> query =
  ...
  public List<GamificationActionsHistoryEntity> getAllPointsByDomain(String domain) {
    TypedQuery<GamificationActionsHistoryEntity> query =
  ...
  public List<GamificationActionsHistoryEntity> getAllPointsWithNullDomain() {
    TypedQuery<GamificationActionsHistoryEntity> query =
  ...
  public List<GamificationActionsHistoryEntity> findAllAnnouncementByChallenge(Long challengeId, int offset, int limit) {
    TypedQuery<GamificationActionsHistoryEntity> query =
    ...
    query.setMaxResults(limit);
    List<GamificationActionsHistoryEntity> resultList = query.getResultList();
  ...
  public List<Long> findMostRealizedRuleIds(int offset, int limit, EntityType type) {
    ...
    query.setParameter(FROM_DATE_PARAM_NAME, utilFromDate).setParameter(TO_DATE_PARAM_NAME, utilToDate).setParameter(TYPE, type);
    query.setFirstResult(offset);
    query.setMaxResults(limit);
   ...
   * @return a list of object of type GamificationActionsHistory
   */
  public List<GamificationActionsHistoryEntity> findRealizationsByFilter(RealizationsFilter realizationFilter,
                                                                         int offset,
                                                                         int limit) {
    TypedQuery<GamificationActionsHistoryEntity> query = buildQueryFromFilter(realizationFilter,
                                                                              GamificationActionsHistoryEntity.class,
                                                                              false);
    if (limit > 0) {
      query.setMaxResults(limit);
