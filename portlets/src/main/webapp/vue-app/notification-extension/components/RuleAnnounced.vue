...
export default {
  ...
  computed: {
    ...
    activityUrl() {
      return this.activityId && `${eXo.env.portal.context}/${eXo.env.portal.portalName}/activity?id=${this.activityId}`;
    },
    replyUrl() {
      return this.activityId && `${eXo.env.portal.context}/${eXo.env.portal.portalName}/activity?id=${this.activityId}#comment-reply`
        || '#';
    },
    profile() {
