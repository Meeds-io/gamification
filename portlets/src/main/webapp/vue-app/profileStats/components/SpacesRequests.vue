    ...
    <v-flex
      ...
      <v-layout
        ...
        <v-flex
          ...
          justify-center>
          <div>
            <span class="pe-2 text-uppercase spaceRequestedTitle subtitle-2 profile-card-header" @click="openSpaceRequests()">{{ $t('homepage.profileStatus.spaceRequests') }}</span>
            <v-btn
              fab
              depressed
              dark
...
export default {
  data() {
    return {
      spacesRequests: [],
      spacesRequestsSize: '',
      invitationSpaceUrl: `${ eXo.env.portal.context }/${ eXo.env.portal.defaultPortal}/spaces/receivedInvitations`
    };
  },
  created(){
