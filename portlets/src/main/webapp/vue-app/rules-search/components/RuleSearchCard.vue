...
<template>
  <v-card
    ...
    <div class="d-flex flex-column flex-grow-1 flex-shrink-1 full-width mx-auto px-3 pt-3 overflow-hidden">
      <div
        v-sanitized-html="ruleDescription"
        class="text-wrap text-break caption text-truncate-3">
      </div>
      <div class="d-flex flex-nowrap align-center overflow-hidden mt-auto py-2">
        <v-chip
          color="#F57C00"
