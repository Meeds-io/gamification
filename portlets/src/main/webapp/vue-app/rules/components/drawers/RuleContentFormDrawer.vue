          ...
          <div :class="expanded && 'col-6'" class="d-flex flex-column">
            <div :class="expanded && 'pt-6'">
              <v-stepper-step
                ...
                :editable="!expanded"
                class="ma-0 pa-0">
                <span class="font-weight-bold text-color text-subtitle-1">{{ $t('rule.form.label.stepOne') }}</span>
              </v-stepper-step>
              <v-stepper-items>
            ...
            <div :class="expanded && 'pt-6'">
              <div :class="!expanded && 'pt-6'">
                <v-stepper-step
                  ...
                  <span class="font-weight-bold text-color text-subtitle-1">{{ $t('rule.form.label.stepTwo') }}</span>
                </v-stepper-step>
                <v-stepper-items>
                  <v-slide-y-transition>
                    <div v-show="expanded || (stepper === 2)">
                      <div class="pt-4 pb-2 text-subtitle-1">{{ $t('rule.form.ruleConditionsLabel') }}</div>
                      <div class="ps-7">
                        <v-chip
                          class="ma-2"
            ...
            <div :class="expanded && 'pt-6'">
              <div :class="!expanded && 'pt-6'">
                <v-stepper-step
                  ...
                  class="ma-0 pa-0"
                  :editable="ruleTitleValid && firstStepValid && !expanded">
                  <span class="font-weight-bold text-color text-subtitle-1">{{ $t('rule.form.label.stepThree') }}</span>
                </v-stepper-step>
                <v-stepper-items>
                  <v-slide-y-transition>
                    <div v-show="expanded || (stepper === 3)">
                      <v-card-text class="d-flex flex-grow-1 text-no-wrap text-left text-subtitle-1 px-0 pb-2 pt-4">
            ...
            <div :class="expanded && 'pt-6'">
              <div :class="!expanded && 'pt-6'">
                <v-stepper-step
                  ...
                  class="ma-0 pa-0"
                  :editable="ruleTitleValid && firstStepValid && !expanded">
                  <span class="font-weight-bold text-color text-subtitle-1">{{ $t('rule.form.label.stepFour') }}</span>
                </v-stepper-step>
                <v-stepper-items>
                  <v-slide-y-transition>
