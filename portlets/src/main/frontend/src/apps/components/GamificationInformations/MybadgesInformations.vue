<template>
    ...
    <b-container fluid class="p-4" id="reputation-badge-container">
        ...
        <div>
            <h1> Social Badges</h1>
            <b-col md="4" class="text-center no-padding" v-for="badge in badges" :key="badge" v-if="badge.zone === 'Social'">
        ...
        <div>
            <h1>knowledge Badges</h1>
            <b-col md="4" class="text-center no-padding" v-for="badge in badges" :key="badge" v-if="badge.zone === 'Knowledge'">
